...
class ControlsSubState extends MusicBeatSubstate
{
	...
	var options:Array<Dynamic> = [
		...
		[true],
		[true, 'NOTES (6-KEY)'], 
		[true, 'Back', 'note6_left', '6K Note Back'],
		[true, 'Up', 'note6_up', '6K Note Up'],
		[true, 'Right', 'note6_right', '6K Note Right'],
		[true, 'Left', 'note6_back', '6K Note Left'],
		[true, 'Down', 'note6_down', '6K Note Down'],
		[true, 'Forward', 'note6_forward', '6K Note Forward'],
		[true],
		[true, 'UI'],
