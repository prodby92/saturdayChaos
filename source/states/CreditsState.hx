...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var defaultList:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			["Saturday Chaos Team"],
			["92", "92", "Lead Dev & prod", "https://soundcloud.com/92sleepy", "ff0000"],
			["5leafz", "5leafz", "Artist & prod", "https://soundcloud.com/5leafz", "a6a6a6"],
			["Frankie11998", "frankie", "Charter", "https://www.youtube.com/@frankie11998", "a6a6a6"],
			[""],
			["Psych Engine Team"],
		...
		descText.setFormat(Paths.font("noto.ttf"), 32, FlxColor.WHITE, CENTER/*, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK*/);
