...
class AchievementsMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		nameText.setFormat(Paths.font("noto.ttf"), 32, FlxColor.WHITE, CENTER);
		nameText.scrollFactor.set();

		descText = new FlxText(50, nameText.y + 38, FlxG.width - 100, "", 24);
		descText.setFormat(Paths.font("noto.ttf"), 24, FlxColor.WHITE, CENTER);
		...
		progressTxt.setFormat(Paths.font("noto.ttf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
